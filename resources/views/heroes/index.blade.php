                ...
                <div class="bg-white rounded-lg shadow-sm p-5">
                    <div class="tab-content">
                        <div id="nav-tab-card" class="tab-pane fade show active">
                            ...
                            @endif
                            <a href="{{ route('heroes.create') }}" class="btn btn-success btn-sm">Ajouter un héro</a>
                            <!-- Tableau -->
                            <table class="table">
                                <thead>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('heroes.destroy',$hero->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button class="btn btn-danger btn-sm" type="submit"  onclick="return confirm('Voulez vous vraiment supprimer le héro?')">Supprimer</button>
                                            </form>
                                            @endauth
                                        </td>
                                    </tr>
